...
def create_app():
    ...
    from Gateway.api_v2 import setup_gateway_routes  # 使用 v2 版本
    ...
    app = FastAPI(
        title="OpenClaw",
        description="AI Agent Platform - 智能代理平台",
        version="2.0.0",
        docs_url="/docs",
        redoc_url="/redoc",
...
def main():
    ...
    parser = argparse.ArgumentParser(description="OpenClaw - AI Agent Platform v2")
